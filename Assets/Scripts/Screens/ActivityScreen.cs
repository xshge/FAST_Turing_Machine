...
public abstract class ActivityScreen : ScreenTemplate
{
    [SerializeField]
    protected ActivityScreenManager screenManager;
    virtual public void OnScanStart() { }
    virtual public void OnScanDone() { }
}
