...
{
    [SerializeField]
    bool isInactiveOnStart = false;

    private IEnumerator Start()
    {
        // This allows the Guides to be initialized and shown for one frame, so that 
        // the Alignment Tool can visualize the Guides whether they are visible or not.
        yield return null;
